...
import ClassicVanillaImg from '@/assets/Classic Vanilla.jpg';
import CustardAppleImg from '@/assets/Custard Apple.jpg';
import DulceDeLecheImg from '@/assets/Dulce De Leche.jpg';
import FigHoneyImg from '@/assets/FigHoney.jpg';
import GulkhandImg from '@/assets/Gulkhand.jpg';
...
import BerriliciousImg from '@/assets/Berrilicious.jpg';
import BlackGrapeImg from '@/assets/Black Grape.jpg';
import BlackberryImg from '@/assets/Blackberry.jpg';
import BlackGarlicImg from '@/assets/BlackGarlic.jpg';
import BluepeaImg from '@/assets/Bluepea.jpg';
import BrazilnutImg from '@/assets/Brazilnut.jpg';
import BrownieOverloadImg from '@/assets/Brownie Overload.jpg';
import CherryImg from '@/assets/Cherry.jpg';
import CherryCheeseImg from '@/assets/Cherry Cheese.jpg';
import ChocoButterScotchImg from '@/assets/Choco Butter Scotch.jpg';
import ChocoCocoImg from '@/assets/Choco Coco.jpg';
import ChocoChilliImg from '@/assets/Choco Chilli.jpg';
import ChocoMintImg from '@/assets/Choco Mint.jpg';
import ChocoOrangeImg from '@/assets/Choco Orange.jpg';
import ChocoRaspberryImg from '@/assets/Choco Raspberry.jpg';
import CookieCaramelImg from '@/assets/Cookie Caramel.jpg';
import FreshFigImg from '@/assets/Fresh Fig.jpg';
import FreshMintImg from '@/assets/Fresh Mint.jpg';
import GiandujaImg from '@/assets/Gianduja(Nutella).jpg';
import GiandujaBananaImg from '@/assets/Gianduja(Nutella) Banana.jpg';
import GuavaImg from '@/assets/Guava.jpg';
import HazelnutCoffeeImg from '@/assets/Hazelnut Coffee.jpg';
import HazelnutOrangeImg from '@/assets/Hazelnut Orange.jpg';
import HerbedCheeseImg from '@/assets/Herbed Cheese.jpg';
import HojichaImg from '@/assets/Hojicha.jpg';
import KalaJamunImg from '@/assets/Kala Jamun.jpg';
import KardantuImg from '@/assets/Kardantu.jpg';
import KulfiImg from '@/assets/Kulfi.jpg';
import LakshmanPhalSoursopSorbetImg from '@/assets/Lakshman Phal Soursop Sorbet.jpg';
import LycheeImg from '@/assets/Lychee.jpg';
import MacadamiaImg from '@/assets/Macadamia.jpg';
import MasalaChaiImg from '@/assets/Masala Chai.jpg';
import MascarponeCheeseImg from '@/assets/Mascarpone Cheese.jpg';
import MatchaImg from '@/assets/Matcha.jpg';
import MochaImg from '@/assets/Mocha.jpg';
import OreosticImg from '@/assets/Oreostic.jpg';
import PaanImg from '@/assets/Paan.jpg';
import PeachImg from '@/assets/Peach.jpg';
import PeanutImg from '@/assets/Peanut.jpg';
import PeanutBananaImg from '@/assets/Peanut Banana.jpg';
import PecanImg from '@/assets/Pecan.jpg';
import PersimmonImg from '@/assets/Persimmon.jpg';
import PhysalisImg from '@/assets/Physalis.jpg';
import PomegranateSorbetImg from '@/assets/Pomegranate Sorbet.jpg';
import PoppyVeganImg from '@/assets/Poppy (VEGAN).jpg';
import PumpkinPieImg from '@/assets/Pumpkin Pie.jpg';
import RamphalImg from '@/assets/Ramphal.jpg';
import RaspberryImg from '@/assets/Raspberry.jpg';
import SingleOriginChocolatesImg from '@/assets/Single Origin Chocolates.jpg';
import TenderCoconutImg from '@/assets/Tender Coconut.jpg';
import VeganIceCreamSFImg from '@/assets/Vegan Ice cream (SF).jpg';
import WalnutImg from '@/assets/Walnut.jpg';
import WhiteChocolateImg from '@/assets/White Chocolate.jpg';
...
import BriocheIceCreamSandwichImg from '@/assets/Brioche Ice cream Sandwich.jpg';
import CrispyChillyCheesToastImg from '@/assets/Crispy Chilly Cheese Toast.jpg';
...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Dulce De Leche', image: DulceDeLecheImg, description: 'Traditional Argentinian classic. A great way to satisfy that sweet tooth' },
      { name: 'FigHoney', image: FigHoneyImg, description: 'Honey roasted Fig with white creamy ice cream' },
      { name: 'Gulkhand', image: GulkhandImg, description: 'Red Rose Gulkand is infused with white creamy ice cream' },
      { name: 'Jackfruit', image: JackfruitImg, description: 'Bursting with flavor' },
      ...
      { name: 'Apricot', image: ApricotImg, description: 'Sweet tart apricots hit you on the front of the palate with the creaminess on the tongue' },
      { name: 'Banana', image: BananaImg, description: 'Fresh Bananas caramelized in brown sugar' },
      { name: 'Berrilicious', image: BerriliciousImg, description: 'Heavenly berries in one ice cream' },
      { name: 'Black Grape', image: BlackGrapeImg, description: 'Like eating a frozen grape, made with fresh black grape' },
      { name: 'Blackberry', image: BlackberryImg, description: 'Slowly disengage from reality with this blissful Blackberry ice cream' },
      ...
      { name: 'Bluepea', image: BluepeaImg, description: 'All natural vibrant Blue Ice Cream that looks absolutely gorgeous. Delightful and refreshing flavor' },
      { name: 'Brazilnut', image: BrazilnutImg, description: 'This energy dense, highly nutritious , nutty ice cream is a trip to the Amazon' },
      { name: 'Brownie Overload', image: BrownieOverloadImg, description: 'Vanilla ice cream with lots and lots of homemade gooey brownie' },
      { name: 'Cherry', image: CherryImg, description: 'Deliciously rich, creamy and tart treat made from real cherries' },
      ...
      { name: 'Choco Butter Scotch', image: ChocoButterScotchImg, description: 'Rich home made butterscotch sauce with coverture chocolate, make a taste treat never forgotten' },
      { name: 'Choco Coco', image: ChocoCocoImg, description: 'This scrumptious treat combines the the nuttiness of the toasted coconut with pure single origin colombian white chocolate, an amazing flavor combination' },
      { name: 'Choco/Chilli', image: ChocoChilliImg, description: 'Enjoy the rich chocolate, feel the kick of chili & the warmth in the back of your throat.' },
      { name: 'Choco/Mint', image: ChocoMintImg, description: 'Fresh home-grown peppermint leaves infused into dark chocolate ice cream' },
      { name: 'Choco/Orange', image: ChocoOrangeImg, description: 'Skeptical of chocolate with citrus, one taste will be all it takes to convince you.' },
      { name: 'Choco/Raspberry', image: ChocoRaspberryImg, description: 'A luscious treat of Rich Dark Chocolate with sweet & tart Red Raspberry' },
      { name: 'Cookie Caramel', image: CookieCaramelImg, description: 'A scrumptious blend of Cookie with home-made caramel, irresistible !!' },
      { name: 'Fresh Fig', image: FreshFigImg, description: 'Made with Fresh Fig roasted in Brown Sugar and Honey' },
      { name: 'Fresh Mint', image: FreshMintImg, description: 'A lively, deliciously refreshing fresh home-grown peppermint ice cream, feel the menthol freshness !!' },
      { name: 'Gianduja(Nutella)', image: GiandujaImg, description: 'Blended with our own Hazelnut-Chocolate spread, BETTER than Nutella !!' },
      { name: 'Gianduja(Nutella) Banana', image: GiandujaBananaImg, description: 'Our own Hazelnut-Chocolate spread blended with banana to make this creamy nutty chocolaty nice cream , creamy and luxurious ...' },
      { name: 'Guava', image: GuavaImg, description: 'Tantalize your taste buds with super rich natural taste of fresh Guava' },
      { name: 'Hazelnut/Coffee', image: HazelnutCoffeeImg, description: 'Hazelnuts jazz up the earthy flavours of coffee, a amazing combo that heightens the flavor of both ingredients.' },
      { name: 'Hazelnut Orange', image: HazelnutOrangeImg, description: 'A creamy toasted hazelnuts icecream mixed with refreshing oranges' },
      { name: 'Herbed Cheese', image: HerbedCheeseImg, description: 'This Cheese Ice Cream with herbs is a delicious, elegant, and unexpected summer dessert.' },
      { name: 'Hojicha', image: HojichaImg, description: 'Dive into the luxurious flavors of Japanese roasted green tea with a distinctive earthy scent, sweet smoky flavor, and autumnal red-brown color, a powerhouse of antioxidants' },
      { name: 'Kala Jamun', image: KalaJamunImg, description: 'Exotic ice cream made with fresh and juicy Black Jamun' },
      { name: 'Kardantu', image: KardantuImg, description: 'A royal sweet of Karnataka loaded with exotic dry fruits and nuts mixed into our creamy vanilla ice cream' },
      { name: 'Kulfi', image: KulfiImg, description: 'The royal treat' },
      { name: 'Lakshman Phal/Soursop Sorbet', image: LakshmanPhalSoursopSorbetImg, description: 'Fiber rich fruit filled with beneficial antioxidants' },
      { name: 'Lychee', image: LycheeImg, description: 'Heavenly taste' },
      { name: 'Macadamia', image: MacadamiaImg, description: 'Creamy and buttery ice cream with roasted macadamia nut butter, Hawaiian divine flavours !!' },
      { name: 'Masala Chai', image: MasalaChaiImg, description: 'Complex blend freshly hand-ground aromatic spices and Indian black tea' },
      { name: 'Mascarpone Cheese', image: MascarponeCheeseImg, description: 'A chefs delight that oozes wholesome flavor' },
      { name: 'Matcha', image: MatchaImg, description: 'Japanese legendary delicacy , with a deep intensity and rich texture, this green tea ice cream instantly takes you back to Japan.' },
      { name: 'Mocha', image: MochaImg, description: 'Fresh espresso coffee with Dark Chocolate' },
      { name: 'Oreostic', image: OreosticImg, description: 'Twice the fun with soft vanilla ice cream & crushed Oreo cookies' },
      { name: 'Paan', image: PaanImg, description: 'A digestive dessert, a refreshing after-dinner treat with real paan leaves' },
      { name: 'Peach', image: PeachImg, description: 'This deliciously irresistible ice ream is creamy,decadent and bursting with fresh peaches.' },
      ...
      { name: 'Peanut Banana', image: PeanutBananaImg, description: 'Dreamy and Creamy ice cream made with homemade peanut butter and ripe bananas, healthy and amazing..' },
      { name: 'Pecan', image: PecanImg, description: 'The magnificent flavor of roasted pecans folded into a rich creamy ice cream,a delight to your senses..' },
      ...
      { name: 'Pomegranate Sorbet', image: PomegranateSorbetImg, description: 'Refreshing and anti-oxidant: Fresh squeezed pomegranates for a tarty, complex and intense sorbet' },
      { name: 'Poppy (VEGAN)', image: PoppyVeganImg, description: 'Sleep therapy, Khus Khus grounded with Jaggery traditionally and mixed with freshly squeezed coconut milk' },
      { name: 'Pumpkin Pie', image: PumpkinPieImg, description: 'Spiced Pumpkin, Unique, Luxuriously rich and flavorful' },
      { name: 'Ramphal', image: RamphalImg, description: 'Lusciouss, creamy buttery texture fruit treat' },
      { name: 'Raspberry', image: RaspberryImg, description: 'Fruity dessert of your dreams! A delicious, indulgent, rich and creamy ice cream made with Real Raspberries' },
      { name: 'Single Origin Chocolates', image: SingleOriginChocolatesImg, description: 'A sophisticated flavor and aroma with our single origin chocolates from PERU and COLOMBIA' },
      { name: 'Tender Coconut', image: TenderCoconutImg, description: 'Dive into this intense Tropical breeze, gelato made with fresh, tender coconut chunks' },
      { name: 'Vegan Ice cream (SF)', image: VeganIceCreamSFImg, description: 'Sinfully Delicious Dairy-Free Delights (no added sugar) made with all natural dates syrup from UAE (Check for Flavours)' },
      { name: 'Walnut', image: WalnutImg, description: 'This scrumptious ice cream is rich with smoky notes from the toasted walnuts, your dose of omega-3 fatty acid' },
      { name: 'White Chocolate', image: WhiteChocolateImg, description: 'An intense pleasure, rich in single origin pure white chocolate from COLOMBIA' },
    ],
  },
  {
    name: 'Hot Chocolate',
  ...
  },
  {
    ...
    items: [
      ...
      { 
        ...
        image: BriocheIceCreamSandwichImg,
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Coconut Sorbet (VEGAN)', image: CommonVeganSorbetImg, description: 'Tropical bliss, made with fresh coconut milk' },
      { name: 'Cucumber Sorbet', image: CommonVeganSorbetImg, description: 'Keep cool with a refreshing cucumber sorbet' },
      { name: 'Green Grape Sorbet', image: CommonVeganSorbetImg, description: 'Juicy green grapes, freshly squeezed Lemon and fresh home-grown peppermint this frozen treat is the ultimate refreshing dessert!!' },
